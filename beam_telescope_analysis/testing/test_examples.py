...
from beam_telescope_analysis.examples import eutelescope, fei4_telescope, simulated_data
...
orig_fit_track = beam_telescope_analysis.track_analysis.fit_tracks
