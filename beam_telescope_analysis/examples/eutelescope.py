...
from beam_telescope_analysis import hit_analysis, dut_alignment, track_analysis, result_analysis
from beam_telescope_analysis.tools import analysis_utils, data_selection
...
def run_analysis(data_files):
    ...
    z_positions = [0.0, 150000.0, 300000.0, 450000.0, 600000.0, 750000.0]  # z position in um
    ...
    result_analysis.calculate_residuals(input_tracks_file=os.path.join(output_folder, 'Tracks_selected_chi2.h5'),
                                        input_alignment_file=os.path.join(output_folder, 'Alignment.h5'),
