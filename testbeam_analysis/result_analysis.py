...
def calculate_efficiency(input_tracks_file, input_alignment_file, bin_size, pixel_size, n_pixels, output_efficiency_file=None, dut_names=None, sensor_sizes=None, minimum_tracks_per_bin=0, use_duts=None, max_chi2=None, use_prealignment=False, cut_distance=None, max_distance=1000, charge_bins=None, dut_masks=None, col_range=None, row_range=None, efficiency_range=None, show_inefficient_events=False, plot=True, gui=False, chunk_size=1000000):
